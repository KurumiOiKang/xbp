...
def create_layout(cal_date):
    weekday = ['SUNDAY','MONDAY', 'TUESDAY', 'WEDNDSDAY', 'THURSDAY', 'FRIDAY', 'SATURDAY']  
    ...
    def date_judgement(i, day):
        if day == today:
            return sg.Text(day.day, size=(11,4), justification='right', text_color='white', background_color='gray')
